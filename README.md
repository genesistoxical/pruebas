...
- **Icons (size):** By clicking on `Icon` a menu will be displayed with two options and you must activate the box you prefer; **Multiple** generates icons that include all the necessary sizes (16, 32, 48, 64, 128, 256 px) to make it look perfect. **256 px** generates icons with a single size, however, it may look pixelated when displayed small.
