...
>* Please note that you must first compile the source code in Visual Studio to get the binaries, otherwise, you will get an [📍Compiler Error](https://github.com/genesistoxical/drop-icons/issues/3).
