...
- **Icons (size):** By clicking on `Icon` a menu will be displayed with two options for you to activate the box you prefer; **Multiple** generates icons that include all necessary sizes such as 16, 32, 48, 64, 128 and 256 px. On the other hand, **256 px** generates icons of a single size but they look pixelated when displayed small.
