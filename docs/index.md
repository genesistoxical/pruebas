...
- Open an image ![_Open](https://github.com/genesistoxical/pruebas/blob/main/docs/assets/buttons/_Info.png) (it must be in PNG format). The margins with empty pixels will be automatically cropped.
