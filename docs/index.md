...
- Open an image <picture><img alt="Pixie Cursors create cursors app" src="assets/_Info.png"/></picture> (it must be in PNG format). The margins with empty pixels will be automatically cropped.
